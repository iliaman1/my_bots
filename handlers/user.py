...
def register_user_handlers(dp: Dispatcher):
    ...
    dp.callback_query.register(process_forward_press, Text(text="forward"))
    dp.callback_query.register(process_backward_press, Text(text="backward"))
